...
| **boss befriended** | the boss reward screen. The run companion moves from home into the foreground and sends a heart to the new boss; the old collection lineup is omitted so the two characters own the moment | `BossCollect.celebration` |
