...
| **prompt** | the character on the slime. The body folds over it while invulnerable; the surprised prompt blends into the slime color and fades away in front of the skin, then slips out as the skin relaxes. Answer it while exposed before its two-to-one-second deadline or it leads a volley | `promptT`, `promptDelay` |
