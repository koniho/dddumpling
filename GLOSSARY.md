...
have varying thickness along their length, faint fills with soft underside shading for rounded volume, and key-colored outlines matching the hexagons. Limbs render behind the characters
