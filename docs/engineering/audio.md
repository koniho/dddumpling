...
`Narration` supplies a single emphasized name with a high, cutesy pitch, separate
from story narration. Android warms its offline speech engine on the title screen; both hosts
