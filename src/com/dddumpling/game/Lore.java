...
final class Lore {
    ...
    static final String[] WHERE = {
        ...
        "THE WOBBLY CLUBHOUSE DOOR", "THE CLUBHOUSE JELLY CUPBOARD", "THE EIGHT-SEAT TEA TABLE", "THE CLUBHOUSE MUSHROOM GARDEN",
        "THE WARMEST BURROW IN THE MINE",
        "THE FLOWER POT BY THE TUNNEL",
        "THE CART FULL OF SOFT PEBBLES",
        "THE GLOWING CRYSTAL CROSSROADS",
        "THE TINY LANTERN WORKSHOP",
        "THE FRONT ROW OF EVERY GIG",
        "THE SOFTEST LOOP IN THE CAVE",
        "THE BASS AMP, SNOOZING",
        "THE ECHO CHAMBER AFTER DARK",
        "THE GOLDEN ENCORE SPOTLIGHT",
    };
    ...
    static final String[][] STORY = {
        ...
        {"HE USED TO GUARD THE BIG DOOR.", "NOW HE HOLDS IT FOR HIS COUSINS.", "THEY ALL BRING LITTLE SNACKS.", "HE SAVES THE WOBBLIEST FOR YOU."},
        {"HE SPLITS TO SHARE THE CHORES.", "ONE HALF WASHES HIS FAMILY CUPS.", "THE OTHER HALF DRIES HIS FRIENDS.", "THEY BOTH FORGET ABOUT THE CUPS."},
        {"EIGHT ARMS SET THE PARTY TABLE.", "ONE MORE PLATE WOULD BE NICE.", "HIS COUSINS BRING THEIR OWN.", "HE WAVES WITH ALL EIGHT ARMS."},
        {"SHE SHAKES OUT TINY GOLD SPORES.", "HER COUSINS CALL THEM CONFETTI.", "THE CLUB HAS A PARTY EACH DAY.", "SHE BRINGS THE ROOF AND THE HAT."},
        {"HE DIGS A ROOM FOR EVERY COUSIN.", "THE ROOMS ALL JOIN AT TEATIME.", "HIS FAMILY BRINGS THE BISCUITS.", "HE BRINGS A VERY SMALL SHOVEL."},
        {"SHE PLANTS FLOWERS IN OLD CARTS.", "HER BROTHERS WATER EVERY ONE.", "THE TUNNEL SMELLS LIKE SPRING.", "NOBODY MINDS THE EXTRA TRIPS."},
        {"HE SLEEPS THROUGH EVERY PICKAXE.", "HIS SISTERS PUSH HIS CART HOME.", "HE WAKES TO HELP WITH SUPPER.", "THEN NAPS BESIDE THE WASHING UP."},
        {"HER NOSE FINDS EVERY CRYSTAL.", "HER COUSINS FOLLOW ITS TWITCH.", "SHE ONCE FOUND A LOST BISCUIT.", "THE FAMILY STILL TELLS THAT ONE."},
        {"HE MAKES A LAMP FOR EVERY MOLE.", "THE LITTLE ONES GET NIGHTLIGHTS.", "HIS FAMILY GLOWS ON THE WAY HOME.", "HE ALWAYS WALKS AT THE BACK."},
        {"SHE TAPS HER TAIL TO EVERY SONG.", "HER COUSINS SWAY FROM SIDE TO SIDE.", "THE WHOLE FAMILY KNOWS THE CHORUS.", "THEY HISS IT ALL THE WAY HOME."},
        {"HE MAKES A LOOP FOR EVERY SISTER.", "THEY CURL UP AFTER THE CONCERT.", "ONE TINY COUSIN NEEDS TWO LOOPS.", "HE ALWAYS LEAVES AN EXTRA ONE."},
        {"SHE LOVES THE LOWEST BASS NOTES.", "HER BROTHERS RUMBLE ALONG TOO.", "THE FLOOR BECOMES A CUDDLE PILE.", "THE FAMILY CALLS IT REHEARSAL."},
        {"HE SINGS WHEN THE MOON IS HIDDEN.", "HIS SISTERS CATCH THE QUIET ECHO.", "THEY PASS IT DOWN THE TUNNEL.", "THE SMALLEST SINGS IT BACK."},
        {"SHE SAVES HER SHINE FOR ENCORES.", "HER COUSINS RAISE THEIR TAILS.", "THE WHOLE CAVE ASKS FOR ONE MORE.", "SHE PLAYS UNTIL THE LAMPS GO OUT."},
    };
    ...
    static final int[] BEAT = {
        ...
        BOUNCE, TUMBLE, HANDOFF, PICNIC,
        PUSH, PICNIC, CARRY, SEEK, HANDOFF, CHEER, STACK, BOUNCE, HANDOFF, CHEER,
    };
