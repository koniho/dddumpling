...
final class ReleaseContent {
    ...
    static final String[][] TEXT={
        ...
        {"TITLE SCREEN AND DURING A RUN","Adjust music and sound effects","independently, with separate","volume and mute controls. Enable","Kids Mode before your next run","for slower play, four keys, and","shorter words."},
        {"AFTER A RUN","Tap finished results to return","to the title.","IN THE RELEASE BOOK","Browse older changes with a","yellow scrollbar, clear of the","keys."},
        {"AFTER A RUN","Zero-hit runs now show 0%","accuracy."},
        {"ON THE TITLE SCREEN","New lands get a little tour,","with clearer trails between","stops.","IN THE RELEASE BOOK","Tap outside to close the list.","Browse with soft bloops and a","little buzz."},
        {"STAR PATH BONUS ROUNDS","Your chosen flyer stays with","you. The rocket loop ends with","one blast-off.","IN THE DISPLAY CASE","Best Score fades away so the","heading stays clear."},
